    ...
    return (
      <Timeline
        ...
        renderEvent={(item) => {
          ...
          return (
            <View className="flex h-full w-full flex-col rounded-lg border border-sevatracker-gray">
              <View
                className={clsx(
                  'pl-3',
              ...
              {item.title === 'Todays Quick Tasks' && (
                <View className="absolute -right-0 -top-1 z-50 h-6 w-6 items-center justify-center rounded-full bg-sevatracker-blue">
                  <Text className="text-sevatracker-white">
                    {
                      tasks?.filter(
                        (task) =>
              ...
              <View className="mt-auto flex flex-row flex-wrap pb-1">
                {item.title !== 'Todays Quick Tasks' && (
                  <View className="flex flex-row items-center pl-2">
                    ...
                    <Text className="ml-1 font-sevatracker-manrope-semibold text-xs">
                      {time}
                    </Text>
                  </View>
                )}
