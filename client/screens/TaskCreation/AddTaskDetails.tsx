    ...
    <SafeAreaView className="bg-sevatracker-white flex-1">
      <GestureHandlerRootView>
        ...
        <ScrollView className="h-[90%]">
          <Text className="font-sevatracker-manrope-bold mt-3 px-4 text-[24px]">
            Task Details
          </Text>
          <TextInputLine
            title={'Title*'}
          ...
          />
          <Text className="font-sevatracker-montserrat-semibold m-4 mb-2">
            {'REPEAT'}
          </Text>
          ...
          <RadioGroup
            ...
            themeColor="bg-sevatracker-blue"
          ...
          <View className="relative z-20 mx-4 mb-0 mt-4">
            <Text className="font-sevatracker-montserrat-semibold mb-2">
              {'LABEL*'}
            </Text>
            <CWDropdown
              selected={label}
