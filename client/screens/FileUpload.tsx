  ...
  return (
    <ScrollView className="flex flex-col align-middle">
      <View>
        ...
        <MainLayout>
          <View>
            <View className="flex w-[100vw] flex-row items-center bg-sevatracker-white">
              <BackButton />
              <View className="flex-1 items-center">
                <Text className="mr-16 text-center font-sevatracker-manrope-bold text-2xl text-sevatracker-blue">
                  Upload File
                </Text>
              </View>
            </View>
            ...
            <View className="relative z-20  mx-2 mt-4 flex flex-row">
              <View className="mr-4 flex-1">
                <Text className="text-md mb-2 font-sevatracker-manrope-bold text-sevatracker-black">
                  FILE TITLE
                </Text>
                <TextInput
                  className="rounded-md border border-sevatracker-gray p-4 font-sevatracker-manrope"
              ...
              <View className="relative z-20 flex-1">
                <Text className="mb-2 font-sevatracker-manrope-bold text-sevatracker-black">
                  FILE LABEL
                </Text>
                <CWDropdown
            ...
            <View className="relative z-10  mx-2 mt-4 flex flex-row">
              <View className="flex-1">
                ...
                <TextInput
                  className="w-full rounded-md border border-sevatracker-gray p-10 font-sevatracker-manrope"
                  placeholder="Text here"
            ...
            <View className="mx-2 mb-2 mt-2 flex flex-row">
              <View className="flex-1">
                <TouchableOpacity
                  className="mt-2 rounded-lg bg-sevatracker-blue px-8 py-5"
                  onPress={submitFile}
                >
                  <Text className="text-center font-sevatracker-manrope text-base text-sevatracker-white">
                    Submit
                  </Text>
                </TouchableOpacity>
              </View>
